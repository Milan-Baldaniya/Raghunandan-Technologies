...
function DockLabel({ children, className = '', ...rest }: any) {
    const { isHovered, alwaysShowLabels } = rest;
    const [isVisible, setIsVisible] = useState(alwaysShowLabels);
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        ...
                        <DockLabel alwaysShowLabels={alwaysShowLabels}>{item.label}</DockLabel>
                    </DockItem>
                ))}
            </motion.div>
        </motion.div>

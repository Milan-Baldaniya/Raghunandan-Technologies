...
const projects = [
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=600&auto=format&fit=crop",
    thumbnailSrc: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=100&auto=format&fit=crop"
  },
  {
    id: 2,
    title: "KRUSHIWORLD",
    ...
    tags: ["Trading", "Agriculture", "Global"],
    imageSrc: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=600&auto=format&fit=crop",
    thumbnailSrc: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=100&auto=format&fit=crop"
  }
];
...
export default function Projects() {
  ...
  // Calculate the visible cards for mobile (current + next 2)
  ...
  return (
    <section id="projects" className="py-8 lg:py-32 bg-black text-white relative overflow-hidden" style={{ zIndex: 60 }}>
      {/* Desktop View - Testimonial Slider Style */}
      ...
      {/* Mobile View - Original 3D Stack */}
      <div className="lg:hidden">
        <div className="container mx-auto px-6 mb-4 relative z-10">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative flex justify-center h-[300px] lg:h-[500px] items-center overflow-hidden">
